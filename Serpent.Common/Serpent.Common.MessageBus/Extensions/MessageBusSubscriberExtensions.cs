...
namespace Serpent.Common.MessageBus
{
    ...
    public static class MessageBusSubscriberExtensions
    {
        ...
        public static SubscriptionWrapper Subscribe<TMessageType>(this IMessageBusSubscriptions<TMessageType> messageBus, Func<TMessageType, Task> invocationFunc, Func<TMessageType, bool> messageFilterFunc = null)
        {
        ...
        /// <returns>A subscription wrapper</returns>
        public static SubscriptionWrapper RegisterFactory<TMessage, THandler>(this IMessageBusSubscriptions<TMessage> messageBus, Func<THandler> messageHandlerFactoryFunc, Func<THandler, Func<TMessage, Task>> messageHandlerFactoryFuncSelector)
        {
        ...
        /// <param name="messageHandlerFactoryFuncSelector">The func that selectes the function to execute on the handler</param>
        /// <returns>A subscription wrapper</returns>
        public static SubscriptionWrapper RegisterFactoryWithDisposableHandler<TMessage, THandler>(this IMessageBusSubscriptions<TMessage> messageBus, Func<THandler> messageHandlerFactoryFunc, Func<THandler, Func<TMessage, Task>> messageHandlerFactoryFuncSelector)
