namespace Serpent.Common.MessageBus.SubscriptionTypes
{
    ...
    public class ExceptionSubscription<TMessageType> : BusSubscription<TMessageType>
    {
        private readonly Func<TMessageType, Task> handlerFunc;

        private readonly Func<TMessageType, Exception, Task<bool>> exceptionHandlerFunc;

        public ExceptionSubscription(Func<TMessageType, Task> handlerFunc, Func<TMessageType, Exception, Task<bool>> exceptionHandlerFunc)
        {
            this.handlerFunc = handlerFunc;
            this.exceptionHandlerFunc = exceptionHandlerFunc;
        }

        public ExceptionSubscription(BusSubscription<TMessageType> innerSubscription, Func<TMessageType, Exception, Task<bool>> exceptionHandlerFunc)
        {
