...
namespace Serpent.Common.MessageBus
{
    ...
    using Serpent.Common.MessageBus.MessageHandlerChain.Decorators.Semaphore;
    ...
    public static class SemapshoreExtensions
    {
        ...
        /// The <see cref="IMessageHandlerChainBuilder&lt;TMessageType&gt;"/>.
        /// </returns>
        public static IMessageHandlerChainBuilder<TMessageType> Semaphore<TMessageType, TKeyType>(this IMessageHandlerChainBuilder<TMessageType> messageHandlerChainBuilder, Func<TMessageType, TKeyType> keySelector, int maxNumberOfConcurrentMessages = 1)
        {
            return messageHandlerChainBuilder.Add(currentHandler => new SemaphoreWithKeyDecorator<TMessageType, TKeyType>(currentHandler, keySelector, maxNumberOfConcurrentMessages));
        }
        ...
        /// The <see cref="IMessageHandlerChainBuilder&lt;TMessageType&gt;"/>.
        /// </returns>
        public static IMessageHandlerChainBuilder<TMessageType> Semaphore<TMessageType, TKeyType>(this IMessageHandlerChainBuilder<TMessageType> messageHandlerChainBuilder, Func<TMessageType, TKeyType> keySelector, IEqualityComparer<TKeyType> equalityComparer, int maxNumberOfConcurrentMessages = 1)
        {
            return messageHandlerChainBuilder.Add(currentHandler => new SemaphoreWithKeyDecorator<TMessageType, TKeyType>(currentHandler, keySelector, new KeySemaphore<TKeyType>(maxNumberOfConcurrentMessages, equalityComparer)));
        }
        ...
        public static IMessageHandlerChainBuilder<TMessageType> Semaphore<TMessageType, TKeyType>(this IMessageHandlerChainBuilder<TMessageType> messageHandlerChainBuilder, Func<TMessageType, TKeyType> keySelector, KeySemaphore<TKeyType> keySemaphore)
        {
