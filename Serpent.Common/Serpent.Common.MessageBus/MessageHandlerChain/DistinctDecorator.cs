namespace Serpent.Common.MessageBus.MessageHandlerChain
{
    ...
    public class DistinctDecorator<TMessageType, TKeyType> : MessageHandlerChainDecorator<TMessageType>
    {
        ...
        public DistinctDecorator(Func<TMessageType, Task> handlerFunc, Func<TMessageType, TKeyType> keySelector)
        {
            this.handlerFunc = handlerFunc ?? throw new ArgumentNullException(nameof(handlerFunc));
            this.keySelector = keySelector ?? throw new ArgumentNullException(nameof(keySelector));
        }

        public DistinctDecorator(Func<TMessageType, Task> handlerFunc, Func<TMessageType, TKeyType> keySelector, IEqualityComparer<TKeyType> equalityComparer)
        {
            this.handlerFunc = handlerFunc ?? throw new ArgumentNullException(nameof(handlerFunc));
            this.keySelector = keySelector ?? throw new ArgumentNullException(nameof(keySelector));
