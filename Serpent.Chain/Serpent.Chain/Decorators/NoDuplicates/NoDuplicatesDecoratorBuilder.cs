namespace Serpent.Chain.Decorators.NoDuplicates
{
    ...
    public class NoDuplicatesDecoratorBuilder<TMessageType> : DecoratorBuilder<TMessageType>
    {
        ...
        public NoDuplicatesDecoratorKeyBuilder<TMessageType, TKeyType> EqualityComparer<TKeyType>(IEqualityComparer<TKeyType> equalityComparer)
        {
        ...
        /// <param name="equalityComparer">The key equality comparer</param>
        /// <returns>A builder</returns>
        public NoDuplicatesDecoratorKeyBuilder<TMessageType, TMessageType> EqualityComparer(IEqualityComparer<TMessageType> equalityComparer)
        {
            equalityComparer = equalityComparer ?? throw new ArgumentNullException(nameof(equalityComparer));
        ...
        /// <returns>A builder</returns>
        public NoDuplicatesDecoratorKeyBuilder<TMessageType, TKeyType> KeySelector<TKeyType>(Func<TMessageType, TKeyType> keySelector)
        {
        ...
        {
            return innerHandler => new NoDuplicatesDecorator<TMessageType, TMessageType>(innerHandler, m => m).HandleMessageAsync;
        }

        private NoDuplicatesDecoratorKeyBuilder<TMessageType, TKeyType> CreateKeyBuilder<TKeyType>()
        {
            var builder = new NoDuplicatesDecoratorKeyBuilder<TMessageType, TKeyType>();
