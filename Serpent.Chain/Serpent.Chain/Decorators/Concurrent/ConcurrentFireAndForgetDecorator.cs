namespace Serpent.Chain.Decorators.Concurrent
{
    ...
    internal class ConcurrentFireAndForgetDecorator<TMessageType> : ChainDecorator<TMessageType>, IDisposable
    {
...
#pragma warning disable CC0004 // Catch block cannot be empty
                    ...
                    {
                        // don't ruin the chain concurrency when the user has not caught an exception
                    }
