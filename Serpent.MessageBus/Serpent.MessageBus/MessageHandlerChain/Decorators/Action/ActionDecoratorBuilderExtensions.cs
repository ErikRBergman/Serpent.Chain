...
namespace Serpent.MessageBus
{
    ...
    public static class ActionDecoratorBuilderExtensions
    {
        ...
        /// A builder
        /// </returns>
        public static IActionDecoratorBuilder<TMessageType> Before<TMessageType>(
            this IActionDecoratorBuilder<TMessageType> builder,
            Func<TMessageType, Task> beforeFunc)
        {
        ...
        public static IActionDecoratorBuilder<TMessageType> Before<TMessageType>(
            this IActionDecoratorBuilder<TMessageType> builder,
            Action<TMessageType> beforeFunc)
        {

            return builder.Before((message, token) =>
                {
                    beforeFunc(message);
        ...
        public static IActionDecoratorBuilder<TMessageType> OnSuccess<TMessageType>(
            this IActionDecoratorBuilder<TMessageType> builder,
            Action<TMessageType> onSuccessAction)
        {
        ...
        /// <returns>A builder</returns>
        public static IActionDecoratorBuilder<TMessageType> OnCancel<TMessageType>(
            this IActionDecoratorBuilder<TMessageType> builder,
            Func<TMessageType, Task> onCancelFunc)
        {
            ...
            Action<TMessageType, Exception> onExceptionFunc)
        {
            ...
            return builder.OnException((message, exception) =>
                {
        ...
        public static IActionDecoratorBuilder<TMessageType> Finally<TMessageType>(
            this IActionDecoratorBuilder<TMessageType> builder,
            Func<TMessageType, Task> finallyFunc)
        {
            ...
            Action<TMessageType, CancellationToken, Exception> finallyAction)
        {
            ...
            return builder.Finally((message, token, exception) =>
                {
        ...
        public static IActionDecoratorBuilder<TMessageType> Finally<TMessageType>(
            this IActionDecoratorBuilder<TMessageType> builder,
            Action<TMessageType> finallyAction)
        {
