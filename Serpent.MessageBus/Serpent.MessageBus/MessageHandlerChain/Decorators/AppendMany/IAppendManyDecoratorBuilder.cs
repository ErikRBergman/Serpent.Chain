...
namespace Serpent.MessageBus
{
    ...
    public interface IAppendManyDecoratorBuilder<TMessageType>
    {
        /// <summary>
        ...
        IAppendManyDecoratorBuilder<TMessageType> Recursive(bool isRecursive = true);

        /// <summary>
        /// Selects the messages to append the message handler chain
        /// </summary>
        /// <param name="messageSelector">The function used to select the message to append</param>
        /// <returns>A builder</returns>
        IAppendManyDecoratorBuilder<TMessageType> Select(Func<TMessageType, CancellationToken, Task<IEnumerable<TMessageType>>> messageSelector);
        ...
        /// <returns>A builder</returns>
        IAppendManyDecoratorBuilder<TMessageType> Where(Func<TMessageType, CancellationToken, Task<bool>> predicate);
    }
}