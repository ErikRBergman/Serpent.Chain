...
## How to install
If you use Visual Studio, open the NuGet client for your project and find `Serpent.MessageBus`.
...
Note! There is a passage later in this document about how to use Serpent.MessageBus with ASP.NET Core.
...
// These are in the Serpent.MessageBus nuget package already. They are only here for clarity
